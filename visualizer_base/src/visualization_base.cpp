...
int VisualizationBase::addCloudToVisualizer (PointCloudConstPtr cloud_ptr, pcl::PointIndicesConstPtr cloud_indices_ptr)
{
...
void VisualizationBase::addCloudsToVisualizer(PointCloudConstPtr cloud_ptr, const std::vector<pcl::PointIndicesConstPtr>& indices_ptrs)
{
  for(std::vector<pcl::PointIndicesConstPtr>::const_iterator itr = indices_ptrs.begin(); itr < indices_ptrs.end(); itr++)
